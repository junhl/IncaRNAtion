...
\frame{
	\frametitle{Energy Landscape}
		\begin{figure}
			\centering
				\includegraphics[ height=0.8\textheight]{Figures/landscape.png}
			\caption{Chen and Dill, 1999}
		\end{figure}	
}
...
\frame{
	...
	Explore mutant space & Explore sequence space\\\pause
	$\mathcal{O}(n^5)$ & $\mathcal{O}(n)$
	& Sequence constraints\\\pause
	\end{tabular}
	\end{table}
}
...
\frame{
	...
	\lred{Avg RFAM \texttt{GC} is $48.8\%$}
	\begin{minipage}{0.49\textwidth}
		\begin{figure}
			\centering
			\includegraphics[width=\textwidth]{Figures/histograme_5_gc_distribution_nornaexinv.png}
		\end{figure}
	\end{minipage}
	\begin{minipage}{0.49\textwidth}
		\begin{figure}
